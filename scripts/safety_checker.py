...
class CustomSafetyChecker(StableDiffusionSafetyChecker):
    ...
    @torch.no_grad()
    def forward(self, clip_input, images, adjustment = 0.0):
        ...
        for i in range(batch_size):
            ...
            for concept_idx in range(len(special_cos_dist[0])):
                ...
                result_img["special_scores"][concept_idx] = round(concept_cos - concept_threshold + _adjustment, 3)
            ...
            for concept_idx in range(len(cos_dist[0])):
                ...
                result_img["concept_scores"][concept_idx] = round(concept_cos - concept_threshold + _adjustment, 3)
